...
<html lang="en">
  ...
  <body class="bg-light">
  <nav class="navbar navbar-expand-lg " class="backgroung-color:green;" data-bs-theme="dark
  ">
  <div class="container">
    <a class="navbar-brand" href="#"><img src="ffff.webp" alt=""></a>
